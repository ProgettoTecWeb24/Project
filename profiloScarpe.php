...
if (!empty($_SESSION['username'])) {
    ...
    if(isset($_POST['likePress'])){
        if (!empty($_SESSION['username'])) {
            ...
            header('Location: profiloScarpe.php#'. htmlspecialchars($_POST['likePress']));
        }else{
                ...
                <div class="img-card-container">
                    ...
                    <div class="text-card">
                        ...
                        <form action="'.$_SERVER['PHP_SELF'].'" method="POST">
                            <button class="like-button" type="submit" name="likePress" aria-label="bottone like scarpa id ' . htmlspecialchars($row['id']) . '" value="' . htmlspecialchars($row['id']) .'">{like}<path
